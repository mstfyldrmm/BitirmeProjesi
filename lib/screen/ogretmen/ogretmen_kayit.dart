...
class OgretmenKayit extends StatelessWidget with NavigatorManager {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBar(themeProvider, 'Öğretmen Kayıt'),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            LoginButton(
              title: 'Kayıt Ol',
              func: () {
                navigateToNoBackWidget(context, OgretmenGiris());
              },
            )
          ],
        ),
